...
module.exports = {
  async create(ctx) {
    if (!ctx.is("multipart")) {
      ...
      const existing_lib_game = await strapi
        .query("library-games")
      ...
      if (existing_lib_game) {
        ...
        return sanitizeEntity(existing_lib_game, {
          model: strapi.models["library-games"],
        });
      }
      await strapi.services["library-games"].create({
        game: game.id,
